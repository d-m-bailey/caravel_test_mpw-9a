...
`define USER_CONFIG_GPIO_16_INIT `GPIO_MODE_USER_STD_INPUT_PULLUP
...
`define USER_CONFIG_GPIO_19_INIT `GPIO_MODE_USER_STD_OUT_MONITORED
...
`define USER_CONFIG_GPIO_27_INIT `GPIO_MODE_MGMT_STD_INPUT_PULLUP
